...
<div class="max-w-screen-md mx-auto bg-blue.gray px-6 py-6 space-y-12 md:py-20">
    ...
    <div class="flex flex-col-reverse gap-6 md:flex-row">
        <div class="flex flex-col gap-2">
            ...
            <div>
                <p>
                    i'm a 22/yr developer from nigeria, i’ve been coding and building stuff since 2018, <Link href="https://docs.python.org/3/">python</Link> is my go to language with a secret love for <Link href="https://eloquentjavascript.net/">javascript</Link> :) i'm open to new opportunities!
                </p>

                {#if seeMore}
                    <p transition:slide={{ duration: 100 }}>
                        <br>
                        i code with other languages too, high levels and low level ones, apart from programming i love playing games, mostly survival and football games, listening to music, i'm currently furthering my knowledge on by pursuing computer science degree and i am loving it so far, being with computers gives me joy and the joy boost me to solve atleast a problem while having fun, i'm lazy smtimes though, below are among the list of things i’ve built, more to build and some still in developent                    </p>
                {/if}
        ...
        <div class="p-1 rounded-full ring-1 ring-white ring-opacity-25 max-w-32 max-h-32">
            <img class="w-full h-full rounded-full" src="<<3.png" alt="Solomon pics" width="400" height="400">
        </div>
    </div>
